    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 flex flex-col items-center justify-center text-center sm:mt-40 ">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-xl">
          ...
          upload your file and start asking questions straight away.
        </p>
        <Link
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files has never been easier than with What
              the File.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="font-sm font-medium text-violet-600">
                Step 1
              </span>
              ...
              <span className="mt-2 text-zinc-700">
                Either start out with a free plan or choose or{" "}
                <Link
                  href="/pricing"
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out What the File today - it really
